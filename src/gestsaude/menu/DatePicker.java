...
/**
 * Mostra uma janela onde se pode escolher uma data.
 * Código adaptado de https://roseindia.net/tutorial/java/swing/datePicker.html
 * 
 * 
 * <br>Nesta classe não é preciso alterar nada<br>
