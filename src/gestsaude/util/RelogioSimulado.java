 ...
 * Este relógio é sempre inicializado às 8h00 do dia atual.<br>
 * Em todo o sistema existe apenas um relógio, dai, para aceder 
 * ao relógio é necessário usar o método <code><b>getRelogioSistema</b></code>, ou em alternativa,
 * para aceder ao tempo atual, ao método <code><b>getTempoAtual</b></code>.<br>
 * Para definir a velocidade do relógio, usar o método <code><b>setTicksPorSegundo</b></code>.
 * 
 * <br><b>NÃO ALTERAR ESTE CLASSE<br>
...
public class RelogioSimulado {
	 ...
	 * corresponderá a <b>ticksPorSegundo</b> segundos no relógio simulado. Inicialmente o relógio tem 
	 * 1 tick por segundo, isto é, 1 segundo real corresponde a 1 segundo simulado.
	 * @param ticksPorSegundo o número de segundos que decorrem em cada segundo do relógio real
	 */
